            ...
            <table class="table table-hover">
                ...
                @forelse($post->comments as $comment)
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a href="{{ route('admin.comments.edit', $comment->id) }}" class="btn btn-primary"><i class="fa fa-edit"></i></a>
                                ...
                                <form action="{{ route('admin.comments.destroy', $comment->id) }}" method="post" id="comment-delete-{{ $comment->id }}" style="display: none;">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </div>
