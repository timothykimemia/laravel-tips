        ...
        <div class="col-lg-9 col-12">
            ...
            <div class="row">
                @if (auth()->user()->user_image != '')
                    <div class="col-12">
                        <img src="{{ asset('storage/assets/users/' . auth()->user()->user_image) }}" class="img-fluid"
                             width="150" alt="{{ auth()->user()->name }}">
                    </div>
                @else
                    <img src="{{ asset('frontend/images/default_avatar.png') }}" class="img-fluid" width="150"
                         alt="{{ auth()->user()->name }}">
                @endif
                <div class="col-12">
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        {!! Form::submit('Update information', ['name' => 'update_information', 'class' => 'btn btn-outline-primary']) !!}
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
            ...
            <div class="row">
                <div class="col-12">
                    <div class="form-group">
                        {!! Form::submit('Update Password', ['name' => 'update_password', 'class' => 'btn btn-outline-danger']) !!}
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
