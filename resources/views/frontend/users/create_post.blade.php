...
@section('content')
    ...
    <div class="col-lg-9 col-12">
        ...
        <div class="form-group">
            ...
            <button type="button" class="btn btn-secondary btn-sm" id="select_btn_tag">Select all</button>
            <button type="button" class="btn btn-secondary btn-sm" id="deselect_btn_tag">Deselect all</button>
