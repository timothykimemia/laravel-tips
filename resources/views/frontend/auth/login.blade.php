...
@section('content')
    <section class="my_account_area pt--80 pb--55 bg--cream">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 offset-md-3">
                    <div class="my__account__wrapper">
                        ...
                        <div class="account__form">
                            ...
                            <div class="form__btn">
                                <a href="{{ route('frontend.social_login', 'facebook') }}" class="btn btn-block mt-2" style="background-color: #1877F2; color: #ffffff;">Login with Facebook</a>
